...
class JC_TopHonor : public CreatureScript
{
public:
	JC_TopHonor() : CreatureScript("JC_TopHonor") { }

	bool OnGossipHello(Player* player, Creature * creature)
	{
		AddGossipItemFor(player, 10, "|TInterface\\icons\\Achievement_BG_winWSG:35:35:-14|tTop 5 Total Honor", GOSSIP_SENDER_MAIN, 1);
		...
		if (sender == GOSSIP_SENDER_MAIN)
		{
			...
			case 1: // TOP 5 TOTAL
			{
				...
				do
				{
					...
					char msg[250];
					snprintf(msg, 250, "Name: |cffFF0000%s|r Honor: |cffFF0000%u|r ", arena_name.c_str(), rating);
