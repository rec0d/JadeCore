...
public:
    ...
    static bool HandleCreatePriestDisciplineItemSetCommand(ChatHandler* handler, const char* args)
    {
        ...
        {
            player->GetSession()->SendAreaTriggerMessage("You are not a priest!");
            return false;
        }
        player->SaveToDB();
    ...
    static bool HandleCreatePaladinHolyItemSetCommand(ChatHandler* handler, const char* args)
    {
        ...
        {
            player->GetSession()->SendAreaTriggerMessage("You are not a paladin!");
            return false;
        }
        player->SaveToDB();
        sTemplateNpcMgr->sTalentsSpec = "Holy";
    ...
    static bool HandleCreateWarriorFuryItemSetCommand(ChatHandler* handler, const char* args)
    {
        ...
        {
            player->GetSession()->SendAreaTriggerMessage("You are not a warrior!");
            return false;
        }
        player->SaveToDB();
    ...
    static bool HandleCreateMageArcaneItemSetCommand(ChatHandler* handler, const char* args)
    {
        ...
        {
            player->GetSession()->SendAreaTriggerMessage("You are not a mage!");
            return false;
        }
        player->SaveToDB();
    ...
    static bool HandleCreateWarlockAfflictionItemSetCommand(ChatHandler* handler, const char* args)
    {
        ...
        {
            player->GetSession()->SendAreaTriggerMessage("You are not a warlock!");
            return false;
        }
        player->SaveToDB();
    ...
    static bool HandleCreateShamanElementalItemSetCommand(ChatHandler* handler, const char* args)
    {
        ...
        {
            player->GetSession()->SendAreaTriggerMessage("You are not a shaman!");
            return false;
        }
        player->SaveToDB();
    ...
    static bool HandleCreateDruidBallanceItemSetCommand(ChatHandler* handler, const char* args)
    {
        ...
        {
            player->GetSession()->SendAreaTriggerMessage("You are not a druid!");
            return false;
        }
        player->SaveToDB();
    ...
    static bool HandleCreateRogueAssassinationItemSetCommand(ChatHandler* handler, const char* args)
    {
        ...
        {
            player->GetSession()->SendAreaTriggerMessage("You are not a rogue!");
            return false;
        }
        player->SaveToDB();
    ...
    static bool HandleCreateDeathKnightBloodItemSetCommand(ChatHandler* handler, const char* args)
    {
        ...
        {
            player->GetSession()->SendAreaTriggerMessage("You are not a death knight!");
            return false;
        }
        player->SaveToDB();
...
public:
    ...
    bool OnGossipSelect(Player* player, Creature* creature, uint32 /*uiSender*/, uint32 uiAction)
    {
        ...
        default: // Just in case
            player->GetSession()->SendAreaTriggerMessage("Something went wrong in the code. Contact the administrator.");
            break;
        }
