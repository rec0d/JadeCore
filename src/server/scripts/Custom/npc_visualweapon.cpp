...
VisualData vData[] =
{
    ...
    { 2, 1, GOSSIP_ICON_TALK, 0, "..Come back" },
    ...
    { 3, 2, GOSSIP_ICON_TALK, 0, "..Come back" },
};
...
public:
    ...
    void SetVisual(Player* player, uint32 visual)
    {
        ...
        if (!item)
        {
            ChatHandler(player->GetSession()).PSendSysMessage("No armor available to change the Visual.");
            return;
        }
    ...
    bool OnGossipHello(Player* player, Creature* creature)
    {
        ...
        AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "|TInterface/PaperDollInfoFrame/UI-GearManager-Undo:32:32:-32:0|tGet out", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 3);
